...
?>
    ...
    <head>
        <meta charset="utf-8">
        <title>DevUno - Web Development</title>
        <link rel="stylesheet" href="login.css" type="text/css">
        <link rel="stylesheet" href="home.css" type="text/css">
        <script src="themeswitcherweb.js"type="text/javascript"></script>
    ...
    <body id="image1">
        ...
        <h1 id="welcomeMessage">Web Development</h1>
        <h2 id="welcomeMessageh2">Design  -  Building  -  Maintenance</h2>
    </body>
